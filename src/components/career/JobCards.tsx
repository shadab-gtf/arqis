...
export default function JobCards() {
  return (
    <div className=' border-[1px] border-[#FFE0AF] p-[30px] mb-[40px] lg:mb-[60px] w-[100%] lg:w-[100%]'>
      ...
      <Redirect_Link customClass={`mt-[50px] text-[14px] change_icon_clr !text-white`} text={`apply Now`} link={``} />
    </div>
  )
}  
