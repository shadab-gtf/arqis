  ...
  return (
    ...
    >
      <Image
        ...
        width={580}
        height={660}
        className={`absolute inset-0 h-full w-full object-contain transition-opacity duration-700 ease-out ${showLocation ? "opacity-0" : "opacity-100"
          }`}
      ...
      <Image
        ...
        width={580}
        height={660}
        className={`absolute inset-0 h-full w-full object-contain transition-opacity duration-700 ease-out ${showLocation ? "opacity-100" : "opacity-0"
          }`}
        sizes="(max-width: 640px) 320px, (max-width: 768px) 420px, (max-width: 1024px) 500px, (max-width: 1280px) 580px, (max-width: 1536px) 640px, 700px"
        priority
      />
